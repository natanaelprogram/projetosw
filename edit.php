...
?>
			...
			<h2 class="mt-3">Atualizar Cliente</h2> <!--Mudar aqui-->

			<form action="edit.php?id=<?php echo $customer['id']; ?>" method="post"> <!--Mudar aqui-->
				...
				<div id="actions" class="row mt-3">
					<div class="col-md-12">
						<button type="submit" class="btn btn-dark"><i class="fa-solid fa-sd-card"></i>&nbspSalvar</button>
						<a href="index.php" class="btn btn-secondary"><i class="fa-solid fa-circle-arrow-left"></i> &nbspCancelar</a>
					</div>
				</div>
			</form>
